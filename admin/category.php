...
?>
 	...
 	<!--banner-->	
		     <div class="banner">
				...
				<span>Categorie of Products</span>
				</h2>
		    </div>
		<!--//banner-->
 	<!--grid-->
 	<div class="grid-form">
 		...
 		<h3 id="forms-example" class="">Add New Product</h3>
...
<div class="tab-pane active text-style" id="tab1">
  <div class="inbox-right">
      ...
      <div class="mailbox-content">
          <div class="mail-toolbar clearfix" style="background-color:#d62f3c; padding: 10px;">
			     <div class="float-left">
			       <div class="btn-group m-r-sm mail-hidden-options" style="display: inline-block;">
                                   <div> <span>Category of Products</span></div>
                            </div>

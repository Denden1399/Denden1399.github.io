        ...
        <table class="table table-bordered">
            ...
            <?php while($row = mysql_fetch_array($unpaid)){ ?>
                <tr>
                    ...
                    <td class="text-center"><a href="order.php?p=deliver&&id=<?php echo $row['id']; ?>" class="btn btn-warning">Deliver</a> &nbsp <a href="order.php?p=delete&&table=order&&id=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a></td>

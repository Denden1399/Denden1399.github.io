...
if (c==null || c=="")
  ...
  return false;
   ...
   var c=document.forms["addproduct"]["supply"].value;
if (c==null || c=="")
  {
  alert("Pls. enter the supply");
  return false;
  }
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="addexec.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
								<div class="form-group">
									<label for="text" class="col-sm-2 control-label">Furniture Name</label>
									<div class="col-sm-8">
								...
								<div class="form-group">
									<label type="text" class="col-sm-2 control-label">Furniture Description</label>
									<div class="col-sm-8">

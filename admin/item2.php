                                ...
                                <table class="table">
                                    ...
                                    <tr>
									 <tr>
                                        ...
                                        <td class="text-info"><strong><?php echo $row['city'];?></strong></td>
                                    </tr>
									 <tr>
                                        <td class="text-right"><strong>Code :</strong></td>
                                        <td class="text-info"><strong><?php echo $row['code'];?></strong></td>
                                    </tr>
									 <tr>
                                        <td class="text-right"><strong>Credit Card :</strong></td>
                                        <td class="text-info"><strong><?php echo $row['creditcard'];?></strong></td>
                                    </tr>
									 <tr>
                                        <td class="text-right"><strong>Credit Card# :</strong></td>
                                        <td class="text-info"><strong><?php echo $row['cnum'];?></strong></td>
                                    </tr>
									 <tr>
                                        <td class="text-right"><strong>CVS :</strong></td>
                                        <td class="text-info"><strong><?php echo $row['cvs'];?></strong></td>
                                    </tr>
                                    ...
                                    <?php if($p == 'unconfirmed'){ ?>
                                        <td class="text-right" colspan="2"><a href="creditcard.php?p=deliver&&id=<?php echo $row['id']; ?>" class="btn btn-warning">Deliver</a></td>
                                    <?php }else if($p == 'delivered'){?>
                                        <td class="text-right" colspan="2"><a href="creditcard.php?p=paid&&id=<?php echo $row['id']; ?>" class="btn btn-warning">Paid</a></td>
                                    <?php } ?>

			...
			<div class="row">
				<div class="col-sm-12">
                            ...
                            <?php endforeach; ?> 
                                ...
                                <tr>
								 ...
								 <tr>
                                    ...
                                    <td colspan="2" class="text-danger">₱ 300</td>
                                </tr>
                                <tr>
                    ...
                    <div class="pull-right">
						...
						<a href="paypal.php" class="btn btn-success btn-lg" data-toggle="paypayl" data-target="checkout_paypal">Credit Card Method</a>
                        <a href="#" class="btn btn-success btn-lg" data-toggle="modal" data-target="#checkout_modal">Cash On Delivery Method</a>
